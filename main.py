...
def driver_id():
    ...
    layout = [
        ...
        [sg.Multiline( key="barcode_saved",size=(50,20))],
        [sg.Button("Submit"),sg.Button("Help")], # add more customers to the array by user if needed
