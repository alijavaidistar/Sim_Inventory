...
def write_sim_inventory():
    ...
    layout = [
        [sg.CalendarButton("Order date:", format='%m/%d/%Y', tooltip="Skip if ordered date is not available"),
         sg.Input(key='order_date', do_not_clear=True, pad=(22, 0), size=(20, 1), disabled=True,
                  background_color="#b0b0b0", text_color="black", tooltip="Click the button to select date")],
        [sg.Text("Customer"), sg.Input(pad=(36, 0), key='customer', do_not_clear=True, size=(20, 1))],
        [sg.Text("Shipment"),
         sg.DropDown(shipment_menu, key="shipment", pad=(37, 0), size=(10, 1), text_color="white")],
        ...
        [sg.CalendarButton("Deliver date:", format='%m/%d/%Y', size=(10, 1)),
         sg.Input(key='deliver', do_not_clear=True, pad=(7, 0), size=(20, 1), disabled=True, background_color="#b0b0b0",
                  text_color="black", tooltip="Click the button to select date")],
        [sg.Text("Comments"),
         sg.Input(key='comments', do_not_clear=True, size=(20, 1), pad=(28, 0), text_color="white")],
        [sg.Button('Submit')]
    ]
...
layout = [
    ...
    [sg.Text("Geometris LP SIM Inventory 2023 - V1.0", text_color="white", ), sg.Image(filename="geologo2_.png")],
    # sg.Image(filename="C:\\Users\\ali\\PycharmProjects\\Sim_Inventory\\geologo2_.png")], fix image
...
window = sg.Window("Geo Sim Inventory - V1.0 - September 2023", layout, titlebar_background_color="black",
                   icon="geo_default_logo.ico")
